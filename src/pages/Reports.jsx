...
const ReportsPage = () => {
    ...
    return (
        <div className="w-full animate-fade-in space-y-4 px-3 md:px-0 pb-4">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs md:text-sm text-slate-500">출력 완료 시 자동 저장되는 결과 기록</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className="px-3 py-2 rounded-lg text-xs font-bold bg-red-600 hover:bg-red-500 text-white inline-flex items-center gap-1.5"
                        >
                            ...
                            >
                                ...
                                <div className="flex flex-wrap items-center justify-between gap-2 mb-2">
                                    <div className="min-w-0">
                                        <div className="text-sm md:text-base font-black text-slate-700 dark:text-slate-100 truncate">
                                            ...
                                            {costValues.length < 2 ? (
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="grid grid-cols-3 gap-2 text-[11px]">
                                                        <div className="rounded-md bg-white dark:bg-slate-800 px-2 py-1 border border-slate-200 dark:border-slate-700">
